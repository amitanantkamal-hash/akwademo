...
$env = [
    ...
    [
        ...
        'fields' => [
            ['separator' => 'General', 'title' => 'Tool used for subscriptions', 'key' => 'SUBSCRIPTION_PROCESSOR', 'value' => 'Razorpay', 'ftype' => 'select', 'data' => []],
            ['title' => 'Enable Pricing', 'key' => 'ENABLE_PRICING', 'value' => 'true', 'ftype' => 'bool'],
            ['title' => 'Enable Pricing for customers', 'key' => 'ENABLE_PRICING_FOR_CUSTOMER', 'value' => 'true', 'ftype' => 'bool'],
            ...
            ['separator' => 'Razorpay', 'title' => 'Razorpay Key ID', 'key' => 'RAZORPAY_KEY', 'value' => 'rzp_test_XXXXXXXXXXXX'],
            ['title' => 'Razorpay Key Secret', 'key' => 'RAZORPAY_SECRET', 'value' => 'sk_test_XXXXXXXXXXXX'],
