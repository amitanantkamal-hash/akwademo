...
return [
    ...
    'free_trail_days' => env('FREE_TRAIL_DAYS', '7'),
    ...
    'otp_resend_allowed_limit' => env('OTP_RESEND_ALLOWED_LIMIT', 1),
    'change_number_allowed_limit' => env('CHANGE_NUMBER_ALLOWED_LIMIT', 1),

    'facebook' => [
        'client_id' => env('FACEBOOK_ADS_CLIENT_ID'),
        'client_secret' => env('FACEBOOK_ADS_CLIENT_SECRET'),
        'redirect' => env('FACEBOOK_ADS_REDIRECT'), // This will be overridden by route
    ],
