...
(function (factory) {
    ...
    var factoryOutput = (() => {
        ...
        var F = (a, t) => {
                for (var e in t) L(a, e, { get: t[e], enumerable: !0 });
            },
            U = (a, t, e, i) => {
        ...
        var B = (a) => U(L({}, "__esModule", { value: !0 }), a);
        var Y = {};
        F(Y, { Iti: () => w, default: () => q });
        var D = [
                ["af", "93"],
        ...
        var $ = { ...A, ...S },
            T = $;
        for (let a = 0; a < f.length; a++) f[a].name = T[f[a].iso2];
        var K = 0,
            P = {
                allowDropdown: !0,
            ...
            b = (a, ...t) => {
                let { instances: e } = r;
                Object.values(e).forEach((i) => i[a](...t));
            },
            w = class {
                constructor(t, e = {}) {
                    (this.id = K++),
                ...
                _f() {
                    ...
                    if (
                        ...
                        if (
                            ((this.l = c("div", { class: "iti__flag" }, y)),
                            ...
                            let g = u ? "" : "iti--flexible-dropdown-width";
                            if (
                                ...
                                l
                                    ? (C += " iti--fullscreen-popup")
                                    : (C += " iti--inline-dropdown"),
                                    (this.dropdown = c("div", { class: C })),
                    ...
                    if (
                        (m.appendChild(this.a), this._updateInputPadding(), s)
                    ) {
                        let y = this.a.getAttribute("name") || "",
                            g = s(y);
                        g.phone &&
                            ((this.hiddenInput = c("input", {
                                type: "hidden",
                                name: g.phone,
                            })),
                ...
                _h(t = !1) {
                    let e = this.a.getAttribute("value"),
                        ...
                        o = this._5(s),
                        u = M(s),
                        { initialCountry: l, geoIpLookup: p } = this.d,
                        h = l === "auto" && p;
                    if (o && !u) this._v(s);
                    else if (!h || t) {
                        let d = l ? l.toLowerCase() : "";
                        d && this._y(d, !0)
                            ? this._z(d)
                            : o && u
                            ? this._z("us")
                    ...
                    /\p{L}/u.test(this.a.value) && (u = !0),
                        (this._a12 = (l) => {
                            if (
                                ...
                                let m = this.a.selectionStart || 0,
                                    y = this.a.value.substring(0, m - 1),
                                    g = this.a.value.substring(m);
                                (this.a.value = y + g), this._nWithPlus();
                                return;
                            }
                            this._v(this.a.value) && this._8();
                            let p = l?.data && /[^+0-9]/.test(l.data),
                                h =
                                    l?.inputType === "insertFromPaste" &&
                                    this.a.value;
                            p || (h && !t)
                                ? (u = !0)
                                : /[^+0-9]/.test(this.a.value) || (u = !1);
                            let d = l?.detail && l.detail.isSetNumber && !n;
                            if (e && !u && !d) {
                                let m = this.a.selectionStart || 0,
                                    g = this.a.value
                                        .substring(0, m)
                                        .replace(/[^+0-9]/g, "").length,
                                    C = l?.inputType === "deleteContentForward",
                                    v = this._9(),
                                    _ = W(g, v, m, C);
                                (this.a.value = v),
                        ...
                        (t || i) &&
                            ((this._handleKeydownEvent = (l) => {
                                if (
                                    ...
                                    if (i && s && o && l.key === "+") {
                                        l.preventDefault(), this._nWithPlus();
                                        return;
                                    }
                                    if (t) {
                                        let p = this.a.value,
                                            ...
                                            g =
                                                ...
                                                l.key +
                                                p.slice(this.a.selectionEnd),
                                            C = this._6(g),
                                            v = r.utils.getCoreNumber(
                                                C,
                                                this.s.iso2
                                            ),
                                            _ =
                    ...
                    if (t && r.utils)
                        if (n) {
                            ...
                            for (; r.utils.isPossibleNumber(o, n, i); )
                                (u = o), (o += "0");
                            let l = r.utils.getCoreNumber(u, n);
                            (this.maxCoreNumberLength = l.length),
                                n === "by" &&
                                    (this.maxCoreNumberLength = l.length + 1);
                ...
                destroy() {
                    ...
                    this._a14 &&
                        i &&
                        i.removeEventListener("submit", this._a14),
            ...
            G = (a) => {
                if (!r.utils && !r.startedLoadingUtilsScript) {
                    let t;
                    if (typeof a == "string")
                        t = import(/* webpackIgnore: true */ a);
                    else if (typeof a == "function")
                        try {
                            if (((t = a()), !(t instanceof Promise)))
                                throw new TypeError(
                                    `The function passed to loadUtils must return a promise for the utilities module, not ${typeof t}`
                                );
                        } catch (e) {
                        ...
                        return Promise.reject(
                            new TypeError(
                                `The argument passed to loadUtils must be a URL string or a function that returns a promise for the utilities module, not ${typeof a}`
                            )
                        );
                    return (
                            ...
                            .then((e) => {
                                ...
                                if (!i || typeof i != "object")
                                    throw typeof a == "string"
                                        ? new TypeError(
                                              `The module loaded from ${a} did not set utils as its default export.`
                                          )
                                        : new TypeError(
