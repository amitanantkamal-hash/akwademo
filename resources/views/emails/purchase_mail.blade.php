					...
					<tr> 
						<td>
							<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									<td>
										<p>{{ env('BUSINESS_LEGAL_NAME') }}</p>
										<address>
											{{ env('BUSINESS_ADD') }}<br>
											{{ env('BUSINESS_PHONE') }}<br>
							...
							<table class="table" width="100%" cellpadding="0"
								...
								<tr>
									...
									<td style="width: 100%">
										<p style="width: 100%">Plan: {{ $plan_name }}</p>
										<p style="width: 100%">Subscription mode: {{ $package_type }}</p>
										<p style="width: 100%">Next renewal date: {{ date('d-m-Y', strtotime(@$expire_date))}}</p>
										<div class="text-muted">Payment Method : {{ @$payment_method }}</div>
									</td>
									<td class="text-center"></td>
									<td class="text-end"></td>
									<td class="text-end" style="width: 23%">$ {{ @$price }}</td>
								</tr>
								</tbody>
							</table>
						</td>
