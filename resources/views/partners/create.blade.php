@extends('layouts.app', ['title' => __('Add Partner')])
@section('content')
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <div class="header pb-8 pt-5 pt-md-8">
        <div class="container-fluid">
            <div class="header-body">
                <h1 class="mb-3 mt--3"><i class="ni ni-circle-08 text-red"></i> {{ __('Add Partner') }}</h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control select2" id="user_id" name="user_id" required>
                                ...
                                @foreach ($users as $user)
                                    @if (!\App\Models\Partner::where('user_id', $user->id)->exists() && $user->id != 1)
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="pan_number" name="pan_number" value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="logo">Company Logo (PNG, JPG only)</label>
