<ul class="navbar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link @if (Route::currentRouteName() == 'partners.index') active @endif" href="{{ route('partners.index') }}">
            <i class="ni ni-circle-08 text-red"></i> {{ __('Partners') }}
        </a>
    </li>

    @if (config('settings.pricing_enabled', true))
        <li class="nav-item ">
            <a class="nav-link @if (Route::currentRouteName() == 'plans.index') active @endif" href="{{ route('plans.index') }}">
    ...
    @if (config('settings.stripe_secret'))
        <li class="nav-item ">
            <a class="nav-link @if (Route::currentRouteName() == 'admin.coupons.index') active @endif" href="{{ route('admin.coupons.index') }}">
                <i class="ni ni-tag text-green"></i> {{ __('coupons_manager') }}
            </a>
        </li>
    @endif
    ...
    @if (!config('settings.hideApps', false))
        <li class="nav-item">
            <a class="nav-link @if (Route::currentRouteName() == 'admin.apps.index') active @endif "
    ...
    @endif
    <li class="nav-item">
        <a class="nav-link @if (Route::currentRouteName() == 'admin.settings.index') active @endif" href="{{ route('admin.settings.index') }}">
