@foreach ($fields as $field)
    @if ($field['ftype'] == 'input' && (isset($reser) ? $reser : false))
        @include('partials.input-reser', $field)
    @else
        @if ($field['ftype'] == 'input')
            @include('partials.input-reminder', $field)
    ...
    @if ($field['ftype'] == 'select')
        @include('partials.select-reminder', $field)
    @endif
