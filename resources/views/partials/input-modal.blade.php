...
@endisset
<div id="form-group-{{ $id }}" class="form-group mt-2 w-100 mt-2 mt-sm-2 ms-sm-0 mt-md-2 ms-md-0 mt-lg-2 ms-lg-0 mt-xl-2 ms-xl-0">
    ...
    <div class="input-group w-100">
        ...
        <input @isset($changevue) @change="{{ $changevue }}" ref="{{ $id }}" @endisset
            ...
            class="form-control form-control-solid w-100 @isset($editclass) {{ $editclass }} @endisset "
