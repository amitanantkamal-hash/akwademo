            ...
            <div class="scroll-y mh-325px my-5 px-8">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-35px me-4">
                            <span class="symbol-label bg-light-primary">
                                <i class="ki-solid ki-abstract-28 fs-2 text-primary"></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-35px me-4">
                            <span class="symbol-label bg-light-danger">
                                <i class="ki-solid ki-information fs-2 text-danger"></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-35px me-4">
                            <span class="symbol-label bg-light-warning">
                                <i class="ki-solid ki-briefcase fs-2 text-warning"></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-35px me-4">
                            <span class="symbol-label bg-light-success">
                                <i class="ki-solid ki-abstract-12 fs-2 text-success"></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-35px me-4">
                            <span class="symbol-label bg-light-primary">
                                <i class="ki-solid ki-colors-square fs-2 text-primary"></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
 ...
 fs-2 text-info"></i>
                ...
                <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-35px me-4">
                            <span class="symbol-label bg-light-warning">
                                <i class="ki-solid ki-color-swatch fs-2 text-warning"></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Title-->
            ...
            <div class="py-3 text-center border-top">
                <a href="?page=pages/user-profile/activity" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All
                    <i class="ki-solid ki-arrow-right fs-5"></i> </a>
            </div>
            <!--end::View more-->
        </div>
        <!--end::Tab panel-->
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
            ...
            <div class="d-flex flex-column px-9">
                ...
                <div class="text-center px-4">
                    <img class="mw-100 mh-200px" alt="image" src="{{ asset('Metronic8.2/assets/media/illustrations/sketchy-1/1.png')  }}" />
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
