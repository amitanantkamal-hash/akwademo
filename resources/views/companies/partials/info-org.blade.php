<div class="pl-lg-4">
    <form id="company-form" method="post" action="{{ route('admin.organizations.update', $company) }}" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
        <div class="col-md-6">
        ...
        @include('partials.fields',['fields'=>[
            ['ftype'=>'input','name'=>"Organization Name",'id'=>"name",'placeholder'=>"Name",'required'=>true,'value'=>$company->name],
            ['ftype'=>'input','name'=>"Description",'id'=>"description",'placeholder'=>"Description",'required'=>true,'value'=>$company->description],
            ['ftype'=>'input','name'=>"Address",'id'=>"address",'placeholder'=>"Address",'required'=>true,'value'=>$company->address],
            ['ftype'=>'input','name'=>"WhatsApp number",'id'=>"phone",'placeholder'=>"9000000000",'required'=>true,'value'=>$company->phone],
        ]])
