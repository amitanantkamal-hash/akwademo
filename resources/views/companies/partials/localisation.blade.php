...
['name'=>'Money conversion', 'class'=> 'mt-2', 'additionalInfo'=>'Some currencies need this field to be unselected. By default it should be selected', 'id'=>'do_covertion', 'value'=>$company->do_covertion==1, 'ftype'=>'bool'],
