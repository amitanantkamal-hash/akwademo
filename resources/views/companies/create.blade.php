@extends('layouts.app', ['title' => __('Organization Management')])

@section('content')
@include('companies.partials.header', ['title' => $title])
                    ...
                    <div class="pl-lg-4">
                        <form method="post" action="{{ route('admin.companies.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="name">{{ __('Organization Name') }}</label>
                                <input type="text" name="name" id="name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter company name') }}" value="" required autofocus>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('name_owner') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="name_owner" id="name_owner" class="form-control form-control-alternative{{ $errors->has('name_owner') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter owner name') }}" value="" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('email_owner') ? ' has-danger' : '' }}">
                                ...
                                <input type="email" name="email_owner" id="email_owner" class="form-control form-control-alternative{{ $errors->has('email_owner') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter owner email') }}" value="" required autofocus>
