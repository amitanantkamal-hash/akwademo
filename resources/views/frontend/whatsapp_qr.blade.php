...
<style>
  ...
  <section class="section-hero">
    <div class="hero-content-left">
      <h1>WhatsApp QR Code Generator – Create Instant Chat QR Codes for Free</h1>
      <p>Say goodbye to engagement hurdles with a WhatsApp QR Code Generator. Make it effortless for current and potential customers to reach you and capture every opportunity</p>
      <button class="btn">Create My WhatsApp QR</button>
    </div>

    <div class="hero-content-right">
      <img src="assets/imgs/images/whtup_QR_code/33.jpg">
    </div>
  </section>
  ...
  <section class="section-why">
    <div class="why-image-box">
      <img src="assets/imgs/images/whtup_QR_code/34.jpg">
    </div>

    <div class="why-content-box">
      <h2>Why Use the Anantkamal Wademo WhatsApp QR Code Generator?</h2>

      <p><span>Engage Audiences Instantly</span><br>
      Create a WhatsApp Business QR code in just a few clicks, allowing anyone to start a conversation instantly—no contact details needed</p>

      <p><span>Enhance Business Processes</span><br>
        Eliminate engagement gaps with a WhatsApp QR Code Generator that lets customers and prospects connect effortlessly—so you never miss an opportunity</p>

      <p><span>Drive Revenue Growth</span><br>
        Unlock hidden revenue opportunities, drive higher sales, and increase profit margins by leveraging personalized WhatsApp QR codes that let customers connect with you instantly and effortlessly</p>
    </div>
  </section>
  ...
  <div class="qr-step-item">
    ...
    <p>Simply enter your WhatsApp Business number into WADEMO WhatsApp QR Code Generator</p>
  </div>
  ...
  <div class="qr-step-item">
    ...
    <h3>Add Your Custom Message</h3>
    <p>Include a captivating message with your WhatsApp QR code to make interactions more engaging</p>
  </div>
  ...
  <div class="qr-step-item">
    ...
    <h3>Generate Your WhatsApp QR Code</h3>
    <p>Once ready, click on ‘Generate QR Code’ to get your unique, free WhatsApp QR code</p>
  </div>
