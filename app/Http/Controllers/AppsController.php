...
class AppsController extends Controller
{
    ...
    public function updateApps(Request $request, Company $company)
    {
        // Update custom fields
           if ($request->has('custom')) {
        $company->setMultipleConfig($request->custom); // Use $company directly
    }

    return response()->json([
        'success' => true,
        'message' => 'Company app settings successfully updated.',
    ]);
    }
