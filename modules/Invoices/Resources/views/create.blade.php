...
@section('content')
    <div id="kt_app_content_container" class="app-container my-10 container-fluid ">
        <!--begin::Layout-->
                ...
                <div class="card">     
                    ...
                    <div class="card-body p-12">
                        ...
                        <form action="" id="kt_invoice_form">
                            ...
                            <!--end::Top-->
                            <!--begin::Separator-->
                            <div class="separator position-static separator-dashed my-10"></div>
                            <!--end::Separator-->
                            <!--begin::Wrapper-->
                            <div class="mb-0">
                                <!--begin::Row-->
                ...
                <div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95" style="">
                    ...
                    <div class="card-body p-10">  
                        ...
                        <div class="mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->           
                            <select name="currnecy" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select currency" class="form-select form-select-solid select2-hidden-accessible" data-select2-id="select2-data-7-vsl4" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                <option value="" data-select2-id="select2-data-9-tdjx"></option>
                                <option data-kt-flag="{{asset('flags')}}/united-states.svg" value="USD">USD&nbsp;-&nbsp;USA dollar</option>
                                <option data-kt-flag="{{asset('flags')}}/united-kingdom.svg" value="GBP">GBP&nbsp;-&nbsp;British pound</option>
                                <option data-kt-flag="{{asset('flags')}}/australia.svg" value="AUD">AUD&nbsp;-&nbsp;Australian dollar</option>
                                <option data-kt-flag="{{asset('flags')}}/japan.svg" value="JPY">JPY&nbsp;-&nbsp;Japanese yen</option>
                                <option data-kt-flag="{{asset('flags')}}/sweden.svg" value="SEK">SEK&nbsp;-&nbsp;Swedish krona</option>
                                <option data-kt-flag="{{asset('flags')}}/canada.svg" value="CAD">CAD&nbsp;-&nbsp;Canadian dollar</option>
                                <option data-kt-flag="{{asset('flags')}}/switzerland.svg" value="CHF">CHF&nbsp;-&nbsp;Swiss franc</option>
                            </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-8-2od1" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-currnecy-a4-container" aria-controls="select2-currnecy-a4-container"><span class="select2-selection__rendered" id="select2-currnecy-a4-container" role="textbox" aria-readonly="true" title="Select currency"><span class="select2-selection__placeholder">Select currency</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>            
                            <!--end::Select-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Separator-->
                        <div class="separator position-static separator-dashed mb-8"></div>
                        <!--end::Separator--> 
                        <!--begin::Input group-->
                        <div class="mb-8">
                            <!--begin::Option-->
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <span class="form-check-label ms-8 ps-6 fw-bold fs-6 text-gray-700">Payment method</span>
                            </label>
                            <!--end::Option-->
                            <!--begin::Option-->
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
                                <input class="form-check-input" type="checkbox" value="">               
                                <span class="form-check-label ms-8 ps-6 fw-bold fs-6 text-gray-700">Late fees</span>
                            </label>
                            <!--end::Option-->
                            <!--begin::Option-->
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <input class="form-check-input" type="checkbox" value="">               
                                <span class="form-check-label ms-8 ps-6 fw-bold fs-6 text-gray-700">Notes</span>
                            </label>
                            <!--end::Option-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-0">
                            ...
                            <div class="row mb-5">
                                <!--begin::Col-->
                                <div class="col">
                                    <a href="#" class="btn btn-light btn-active-light-primary w-100 keychainify-checked">Preview</a>                
                                </div>   
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col">
                                    <a href="#" class="btn btn-light btn-active-light-primary w-100 keychainify-checked">Download</a>
                                </div>  
                                <!--end::Col-->
                            </div>   
                            <!--end::Row-->
                            <button type="submit" href="#" class="btn btn-info w-100" id="kt_invoice_submit_button">
