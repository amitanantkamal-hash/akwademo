    ...
    <div class="mt-n1">                                    
        ...
        <div class="d-flex flex-stack pb-10">
            ...
            <a href="#" class="keychainify-checked">
                <img alt="Logo" src="{{ asset('media') }}/svg/brand-logos/code-lab.svg">
            </a>
            <!--end::Logo-->
                                
            <!--begin::Action-->            
            <a href="#" class="btn btn-sm btn-success keychainify-checked">Pay Now</a>                 
            <!--end::Action--> 
        </div>                
        <!--end::Top-->                
...
<div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
    ...
    <div class="mb-6">     
        ...
        <div class="fw-bold fs-6 text-gray-800">
            ...
            <a href="#" class="link-primary ps-1 keychainify-checked">View Project</a>
        </div>                  
    </div>                
    <!--end::Item-->  
