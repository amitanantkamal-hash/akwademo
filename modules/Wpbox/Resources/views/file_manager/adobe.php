<?php if ($button): ?>
<a class="dropdown-item ccEverywhere" href="javascript:void(0)"><img src="<?php _ec( get_module_path( __DIR__, "backend/Assets/img/adobe.png") )?>" class="w-17 h-17"> <?php _e("Adobe Express")?></a>
<?php endif ?>
