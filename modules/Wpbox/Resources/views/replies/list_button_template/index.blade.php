                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-nowrap">
                                        <div class="d-flex justify-content-end action-buttons">
                                            <a href="{{ route('list_button_template.edit', ['button' => $item->id]) }}"
                                                class="action-btn btn-icon-primary" data-bs-toggle="tooltip" title="Edit">
                                            ...
                                            <button class="btn btn-icon btn-light btn-active-light-danger btn-sm delete-btn ms-2 me-2"
                                                data-id="{{ $item->id }}"
                                                data-url="{{ route('list_button_template.delete', $item->id) }}"
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="empty-state">
                                            ...
                                            <p class="text-muted mb-5">{{ __('There are no list group created yet') }}</p>
                                            @isset($setup['action_link'])
                                                <a href="{{ $setup['action_link'] }}" class="btn btn-primary">
                                                    <i class="ki-duotone ki-plus fs-2 me-1"></i> {{ $setup['action_name'] }}
                                                </a>
                ...
                button.addEventListener('click', function() {
                    ...
                    if (isStaff) {
                        Swal.fire({
                            ...
                            text: 'You do not have proper rights to delete this list group.',
                            toast: true,
                            position: 'top-end',
                    ...
                    Swal.fire({
                        ...
                        <p class="fs-5">Are you sure you want to delete list group<br><b>${templateName}</b>?</p>
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire({
                                title: 'Deleting...',
                                text: 'Please wait while we delete the list group',
                            ...
                            axios.delete(this.dataset.url, {
                                ...
                                .then(response => {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Deleted!',
                                        text: 'Interactive - List group has been deleted!',
                                        toast: true,
                                        position: 'top-end',
                                        showConfirmButton: false,
                                        timer: 2000,
