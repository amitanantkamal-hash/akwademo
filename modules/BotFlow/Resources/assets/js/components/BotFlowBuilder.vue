...
const goBack = () => {
        window.location.href = '/bot-flow-list';
};
                    ...
                    setNodes([
                        {
                            ...
                            data: {
                                label: "Start Trigger",
                                keywords: [],
                                canDelete: false, // 👈 DEFAULT TRIGGER
            ...
            <div class="flex flex-1 flex-col">
                ...
                >
                    ...
                    <div class="flex items-center space-x-2">
                         <button
                            @click="goBack"
                            class="flex items-center space-x-1 rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition-colors duration-150 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
                            title="Back to Flow Bot"
                        >
