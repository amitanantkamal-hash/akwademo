        ...
        el: '#template_creator',
            ...
            methods: {
                ...
                handleImageUpload: function (event) {
                    ...
                    axios.post('/catalog/catalogs-templates/upload-image', formData, {
                        headers: {
                ...
                handleVideoUpload: function (event) {
                    ...
                    axios.post('/catalog/catalogs-templates/upload-video', formData, {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    }).then(response => {
                ...
                handlePdfUpload: function (event) {
                    ...
                    axios.post('/catalog/catalogs-templates/upload-pdf', formData, {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    }).then(response => {
