<script>
    ...
    // Load the JavaScript SDK asynchronouslyre
    (function(d, s, id) {
...
<div class="container" style="display: flex; justify-content: center; align-items: center;">
    ...
    <dotlottie-player id="anim" src="https://lottie.host/1c4e7c05-b40d-4064-b940-e5d1040b2019/bCu4S9tJ4s.json"
        background="transparent" speed="1" style="width: 200px; height: 200px; display: none;" loop
        autoplay></dotlottie-player>
    <dotlottie-player id="success" src="https://lottie.host/c46f068d-2568-46ad-a622-2f9011b0252c/Pcs4qIKy3C.json"
        background="transparent" speed="1" style="width: 300px; height: 300px; display: none;" loop
        autoplay></dotlottie-player>

    <button id="embButton" onclick="launchWhatsAppSignup()" class="btn btn-info btn-whatsapp w-100">
