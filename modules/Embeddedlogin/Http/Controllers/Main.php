...
class Main extends Controller
{
    ...
    public function getWABACurrentStatus()
    {
        $user = Auth::user();
        $company = $user->resolveCurrentCompany();
        if ($company->getConfig('whatsapp_settings_done', 'no') == 'yes') {
            $accessinfo = $this->access_connect($company->getConfig('whatsapp_business_account_id'), $company->getConfig('whatsapp_permanent_access_token'), $company->getConfig('whatsapp_phone_number_id'));
