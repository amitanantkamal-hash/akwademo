...
class Main extends Provider
{
    ...
    {
        Blade::componentNamespace('Modules\Inbox\View\Components', 'inbox');
    }
    ...
    {
        $langPath = resource_path('lang/modules/inbox');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'inbox');
        } else {
            $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang/en', 'inbox');
        }
    }
