...
//   if (!currency.value) {
// 		toastr.error('Please enter a valid 3-letter currency code.');
// 	return;
//   }
...
//   try {
// 	const response = await fetch('/api/generate-stripe-link', {
// 	  method: 'POST',
// 	  headers: {
...
// 		toastr.error('Server did not return valid JSON.');
// 	  return;
// 	}
